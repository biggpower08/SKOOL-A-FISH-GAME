...
export const fishTypeDefinitions: FishTypeDefinition[] = [
  ...
  },
  {
    ...
    description: "Bright, nosy, and excellent at warning the school.",
    mechanics: "Adds four support fish that help nearby fish sense danger and escape cleaner.",
    recruitAmount: 4,
    maxHealth: 2,
    maxSpeed: 2.34,
    radius: 4.25,
    ...
    buildTags: ["parrotfish-evasion", "balanced-school", "anti-shark-survival"],
  },
  {
    id: "mahi-mahi",
    label: "Mahi-Mahi",
